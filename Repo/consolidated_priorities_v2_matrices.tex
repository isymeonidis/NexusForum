...
\caption{Progression Matrix — Priority Cluster~1: Sovereign Trusted
  ...
  generalised methodology framework (Table~\ref{tab:master_transition}).
...
\textit{[cluster composite;\newline see sub-priority\newline decomposition below]}
&
...
% ---- MARKET/SSL ROW ----
\rowcolor{dimMkt}
\cellhead{(4) Market Uptake \&}\newline\cellhead{Strategic Sovereignty}\newline
...
\caption{Progression Matrix — Priority Cluster~2: Cognitive Security and
  ...
  (Table~\ref{tab:master_transition}).}
