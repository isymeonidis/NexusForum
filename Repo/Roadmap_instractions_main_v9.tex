...
\section{Methodology for Cybersecurity Prioritization in the Computing Continuum}
...
The roadmap is produced by a structured, five-stage analytical pipeline
...
It defines the logical organization of cybersecurity capabilities
...
The complete enumeration of candidate capabilities is provided in
...
technically but also in terms of its regulatory alignment, investment
...
\label{sec:exec}
% -----------------------------------------------------------------
The Executive Summary (Section~\ref{sec:executive_summary}) is not a
